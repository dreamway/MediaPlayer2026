...
AdvertisementWidget::~AdvertisementWidget()
{
    if (bPlayImageOrVideo) {
        ...
        if (mQMediaPlayer) {
            mQMediaPlayer->setVideoOutput(nullptr);
            mQMediaPlayer->setAudioOutput(nullptr);
            mQMediaPlayer->stop();
            delete mQMediaPlayer;
            mQMediaPlayer = nullptr;
        }
        if (mQAudioOutput) {
            delete mQAudioOutput;
            mQAudioOutput = nullptr;
        }
    }
    delete ui;
    ui = nullptr;
