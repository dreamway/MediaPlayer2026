    ...
    : QWidget(parent)
{
    ...
    //m_bgColorOn = QColor(47, 112, 214, 255);// 21 156 119
    //m_bgColorOff = QColor(47, 112, 214, 255);//  111 122 126

    m_bgColorOn = QColor(47, 112, 214, 255);   // 21 156 119
    m_bgColorOff = QColor(205, 205, 205, 255); //  111 122 126

    m_sliderColorOn = QColor(255, 255, 255, 255);
    m_sliderColorOff = QColor(255, 255, 255, 255);
